...
router.post('/', upload.single('avatar'), async (req, res) => {
  ...
  } catch (e) { console.error('[GOODBYE CANVAS ERROR]',e); return res.status(500).json({status:false,creator:'FamilyBot-MD',message:'No se pudo generar el Goodbye Canvas.'}); }
});
